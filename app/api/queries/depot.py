...
als auch — sobald verdrahtet (S-071, nicht Teil dieser Story) — von der
HTML-Route (`app.api.ui`) konsumiert (AC1/AC10, kein zweiter
Datenzusammenbau).
...
def hole_depot_uebersicht(
    *,
    ...
    titel = [
        _baue_titel_bestand(titel_id, lots, live_price=live_price)
