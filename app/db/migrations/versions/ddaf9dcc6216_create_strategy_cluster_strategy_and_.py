...
(BR-135, C-014), Verträge-Tabelle in docs/specs/strategie-exit-regeln.md,
...
`passiv_regelbasiert` gesetzt (BR-135) — die eigentliche Ablehnung einer
...
# 4 Cluster (C-014) — MVP-Freischaltung (AC2, BR-135): ausschliesslich
