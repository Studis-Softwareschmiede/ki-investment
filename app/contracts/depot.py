...
- `FillInput` — das Ausführungsergebnis vom Kauf-/Verkaufsmodul. Die
  universellen Pflichtfelder (Titel-Identität, Anlageklasse, GICS-Branche,
  Richtung, Menge, Fill-Preis, Kosten, Arrival-Price, Währung, Zeitstempel)
  sind Pydantic-Pflichtfelder (AC10, deckt E1: "fehlende Pflichtfelder");
...
- `FillErgebnis` — strukturiertes Ergebnis des Buchungs-Gates
  ...
  Fortschreibung mit Ø-Einstand/Gebühren-Netting ist S-016, AC2/AC3/AC5).

Nicht Teil dieser Story (andere Storys/Nicht-Ziele):
- Keine G/V-Berechnung, kein Gebühren-Netting, keine Einstand-Methode
  (AC2/AC3/AC5 → S-016).
